...
function S._every(self)
    self.beat = self.beat == nil and 0 or self.beat
    return (self.ix % turtle(self.n)) == (self.beat % self.n)
end
...
function S.every(self, n, beat) return S.extend(self, {cond = S._every, n = n, beat = beat}) end
